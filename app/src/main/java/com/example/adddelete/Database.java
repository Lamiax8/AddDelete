...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_APART_LOC = "APART_LOC";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String createTableStatement = "Create TABLE " + APART_TABLE + " (" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_APART_NAME + " TEXT, " + COLUMN_APART_PRICE + " INT," +COLUMN_APART_LOC+"TEXT,"+COLUMN_APART_ROOMS+"INT)";
    ...
    public boolean addOne(apart apartMod) {
        ...
        cv.put(COLUMN_APART_LOC, apartMod.getLocation());
    ...
    public List<apart> getEveryone() {
        ...
        if (cursor.moveToFirst()) {
            ...
            do {
                ...
                String ALoc = cursor.getString(3);
                int ARooms = cursor.getInt(4);

                apart newApart = new apart(AID, AName, APrice,ALoc,ARooms);
